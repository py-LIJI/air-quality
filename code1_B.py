...
dat=pd.read_excel('dataset_B/data_B_y.xlsx')
...
dat_y.iloc[1:355, :].to_excel('dataset_B/yuce_b.xls')

#%%
dat_s=pd.read_excel('dataset_B/data_B_s.xlsx')
dat_s['B']=dat_y['B'][0:355]
dat_s.to_excel('dataset_B/shice_b.xls')
...
dat_x.to_excel('dataset_B/xiuzheng_b.xlsx')
