...
dat=pd.read_excel('dataset_A2/data_A2_y.xlsx')
...
dat_y.iloc[1:355, :].to_excel('dataset_A2/yuce_A2.xls')


#%%
dat_s=pd.read_excel('dataset_A2/data_A2_s.xlsx')
dat_s['B']=dat_y['B'][0:355]
dat_s.to_excel('dataset_A2/shice_A2.xls')
...
dat_x.to_excel('dataset_A2/xiuzheng_A2.xls')
