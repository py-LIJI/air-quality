...
dat=pd.read_excel('dataset_A3/data_A3_y.xlsx')
...
dat_y.iloc[0:351, :].to_excel('dataset_A3/yuce_A3.xls')

#%%
dat_s=pd.read_excel('dataset_A3/data_A3_s.xlsx')
dat_s['B']=dat_y['B'][0:351]
dat_s.to_excel('dataset_A3/shice_A3.xls')
...
dat_x['B']=dat_y['B'][0:351]

dat_x.to_excel('dataset_A3/xiuzheng_A3.xls')
