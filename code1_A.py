...
dat=pd.read_excel('dataset/data1_1.xlsx')
...
dat_y.iloc[1:355, :].to_excel('dataset/yuce_1.xls')


#%%
dat_s=pd.read_excel('dataset/data1_3.xlsx')
dat_s['B']=dat_y['B'][0:355]
dat_s.to_excel('dataset/shice_1.xls')
...
dat_x.to_excel('dataset/result_1.xls')
