...
dat=pd.read_excel('dataset_C/data_C_y.xlsx')
...
dat_y.iloc[1:355, :].to_excel('dataset_C/yuce_c.xls')

#%%
dat_s=pd.read_excel('dataset_C/data_C_s.xlsx')
dat_s['B']=dat_y['B'][0:355]
dat_s.to_excel('dataset_C/shice_c.xls')
...
dat_x.to_excel('dataset_C/xiuzheng_c.xlsx')
